...
//
//    companion object {
//        private val postgresDockerImage = "postgres:16.0"
//
//        @Container
//        val container = PostgreSQLContainer(postgresDockerImage).apply {
...
//        jdbc.update("insert into address(country, city, street, building, entrance, floor) " +
