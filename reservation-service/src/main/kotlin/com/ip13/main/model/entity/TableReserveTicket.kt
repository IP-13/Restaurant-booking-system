...
class TableReserveTicket(
    ...
    override fun hashCode(): Int {
        ...
        result = 31 * result + (managerId?.hashCode() ?: 0)
    ...
    override fun toString(): String {
        return "TableReserveTicket(id=$id, restaurant=$restaurantId, user=$userId, creationDate=$creationDate, " +
                "fromDate=$fromDate, tillDate=$tillDate, numOfGuests=$numOfGuests, userComment=$userComment, " +
                "manager=$managerId, managerComment=$managerComment, status=$status)"
    }
}